...
const PayForProduct3 = () => {
  ...
  return (
    <div className="relative bg-white-10 w-full h-[73.25rem] overflow-hidden text-left text-[1.19rem] text-secondary-main font-px-body-text">
      <div className="absolute top-[0rem] left-[0rem] bg-white w-[65.81rem] overflow-hidden flex flex-row py-[1.25rem] px-[2.5rem] box-border items-center justify-start gap-[1.25rem] text-[1.75rem]">
        <img
      ...
      <div className="absolute h-[92.92%] w-[100.14%] top-[6.83%] right-[-0.14%] bottom-[0.26%] left-[0%] bg-gray [backdrop-filter:blur(10px)]" />
      <div className="absolute top-[6.88rem] left-[11.5rem] bg-white w-[67.06rem] h-[47.56rem] overflow-hidden">
        <div className="absolute top-[6.25rem] left-[12.94rem] flex flex-col items-center justify-start gap-[2.25rem]">
          ...
          <div className="flex flex-row items-start justify-start gap-[1.25rem]">
            <div className="rounded-3xs bg-white-10 w-[9.38rem] flex flex-col py-[0.63rem] px-[1.25rem] box-border items-center justify-center gap-[1.25rem]">
              <div className="flex flex-col items-center justify-start gap-[0.63rem]">
                <img
                  ...
                  src="/image-47@2x.png"
                />
                <div className="relative font-medium">Metamask</div>
              </div>
              <div className="rounded bg-primary-light flex flex-row py-[0.25rem] px-[0.5rem] items-center justify-center text-[0.81rem] text-primary-main">
            ...
            <div className="rounded-3xs bg-white-10 w-[9.38rem] flex flex-col py-[0.63rem] px-[1.25rem] box-border items-center justify-center gap-[1.25rem]">
              <div className="flex flex-col items-center justify-start gap-[0.63rem]">
                <img
                  ...
                  src="/image-48@2x.png"
                />
                <div className="relative font-medium">Coinbase</div>
              </div>
              <div className="rounded bg-primary-light flex flex-row py-[0.25rem] px-[0.5rem] items-center justify-center text-[0.81rem] text-primary-main">
                <div className="relative">Connect</div>
              </div>
            ...
            <div className="rounded-3xs bg-white-10 w-[9.38rem] flex flex-col py-[0.63rem] px-[1.25rem] box-border items-center justify-center gap-[1.25rem]">
              <div className="flex flex-col items-center justify-start gap-[0.63rem]">
                <img
                  className="relative w-[3.03rem] h-[3.13rem] object-cover"
                  alt=""
                  src="/image-49@2x.png"
                />
                <div className="relative font-medium">Fortmatic</div>
              </div>
              <div className="rounded bg-primary-light flex flex-row py-[0.25rem] px-[0.5rem] items-center justify-center text-[0.81rem] text-primary-main">
                <div className="relative">Connect</div>
              </div>
            ...
            <div className="rounded-3xs bg-white-10 w-[9.38rem] flex flex-col py-[0.63rem] px-[1.25rem] box-border items-center justify-center gap-[1.25rem]">
              <div className="flex flex-col items-center justify-start gap-[0.63rem]">
                <img
                  className="relative rounded-3xs w-[3.03rem] h-[3.13rem] object-cover"
                  alt=""
                  src="/image-491@2x.png"
                />
                <div className="relative font-medium">Wallet connect</div>
              </div>
              <div className="rounded bg-primary-light flex flex-row py-[0.25rem] px-[0.5rem] items-center justify-center text-[0.81rem] text-primary-main">
                <div className="relative">Connect</div>
              </div>
