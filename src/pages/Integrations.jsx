...
const Integrations = () => {
  ...
  return (
    <div className="bg-white overflow-hidden text-left text-[1rem] text-secondary-main font-px-body-text">
      {/* Navbar */}

      {/* Wallet section */}
      <div className="px-[2.5rem] md:px-0 md:ml-[16.88rem]">
        <div className="absolute top-[-38.69rem] left-[-31.87rem] w-[1.25rem] h-[1.25rem] overflow-hidden" />
        <div className="absolute top-[5rem] left-[65.63rem] h-[68.25rem]">
          <div className="absolute top-[0rem] left-[0rem] bg-white-10 w-[24.38rem] h-[68.25rem]" />
          <div className="absolute top-[2.5rem] left-[1.44rem] flex flex-col items-start justify-start gap-[3.75rem]">
        ...
        <div className="absolute top-[5.56rem] left-[19.38rem] text-[1.75rem] font-medium">
          Developer
        </div>
        <div className="absolute top-[13.75rem] left-[19.31rem] flex flex-col items-start justify-start gap-[1.5rem] text-[0.81rem]">
          <div className="flex flex-col items-start justify-start gap-[1.25rem]">
            <div className="self-stretch flex flex-row items-center justify-between text-[1.19rem]">
              <div className="relative font-medium">Main API Configuration</div>
              <div
          ...
          <div className="flex flex-col items-start justify-start gap-[1.25rem]">
            <div className="self-stretch flex flex-row items-center justify-between text-[1.19rem]">
              <div className="relative font-medium">Test API Configuration</div>
              <div
