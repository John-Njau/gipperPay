...
const Integrations = () => {
  ...
  return (
    <div className="main__container flex flex-wrap bg-white text-[1rem] text-secondary-main font-px-body-text left-[5.56rem]">
      {/* Main section - Developer */}
      <div className="developer__section m-[1.25rem]">
      ...
      {/* Wallet section */}
      <div className="wallet__section top-[5rem] left-[1.44rem] flex flex-col items-start justify-start gap-[3.75rem] bg-white-10 p-2 h-100 md:justify-center sm:justify-center">
